...
func multisign1() {
	...
	request, err := service.NewDeployContractRequest(alice, "counter", nil, code, args, "wasm", "c", service.WithOtherAuthRequires(authRequire))
	if err != nil {
		panic(err)
	}
...
func multisign2() {
	...
	tx, err := xclient.DeployWasmContract(alice, "counter", code, args, service.WithNotPost(), service.WithOtherAuthRequires(authRequire))
	if err != nil {
		panic(err)
	}
