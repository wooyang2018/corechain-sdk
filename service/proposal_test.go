...
func (x *eventServiceSubscribeClient) Recv() (*protos.Event, error) {
	m := new(protos.Event)
...
func (mesc *MockESClient) Subscribe(ctx context.Context, in *protos.SubscribeRequest, opts ...grpc.CallOption) (protos.EventService_SubscribeClient, error) {
